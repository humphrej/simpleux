package com.specialprojectslab.simpleux.progress;
/**
* 18:12 17/02/2005
...
//        Point2D.Double center = new Point2D.Double((double) i_iWidth / 2, (double) i_iHeight / 2);
   ...
   public static void main(String[] args) {
       ...
       oButton.addActionListener(new ActionListener() {
           public void actionPerformed(ActionEvent e) {
               final HiPerfInfiniteProgressPanel oWaitingPane = new HiPerfInfiniteProgressPanel(false);
       ...
       oBufferedButton.addActionListener(new ActionListener() {
           public void actionPerformed(ActionEvent e) {
               final HiPerfInfiniteProgressPanel oWaitingPane = new HiPerfInfiniteProgressPanel(true);
               oTestFrame.setGlassPane(oWaitingPane);
               oWaitingPane.setVisible(true);
               Thread oThread = new Thread() {
                   public void run() {
